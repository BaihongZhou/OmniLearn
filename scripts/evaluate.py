...
def load_data_and_model(flags):
    ...
    if flags.train_channel == "pi_pi":
        ...
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_pirho_8_local_layer_scale_token_baseline_generator.weights.h5"
    elif flags.train_channel == "e_pi":
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_epi_8_local_layer_scale_token_baseline_generator.weights.h5"
    elif flags.train_channel == "e_rho":
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_erho_8_local_layer_scale_token_baseline_generator.weights.h5"
    elif flags.train_channel == "mu_pi":
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_mupi_8_local_layer_scale_token_baseline_generator.weights.h5"
    elif flags.train_channel == "mu_rho":
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_murho_8_local_layer_scale_token_baseline_generator.weights.h5"
    elif flags.train_channel == "rho_rho":
        model_name = "/global/cfs/projectdirs/m2616/baihong/shared/OmniLearn/PET_rhorho_8_local_layer_scale_token_baseline_generator.weights.h5"
